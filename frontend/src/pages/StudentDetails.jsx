        ...
        <>
          ...
          <div className="flex flex-col sm:border sm:border-solid sm:rounded sm:border-textBg-200 sm:p-8">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8">
              ...
              <div className="flex items-center text-textBg-700 gap-2">
            ...
            <div className="flex flex-col 2xl:flex-row gap-16">
              <div className="flex flex-col gap-2 w-full 2xl:w-[30%]">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <p className="text-sm sm:text-base ml-7 sm:ml-0">{studentInfo.email}</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm sm:text-base ml-7 sm:ml-0">{studentInfo.phone_number}</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm sm:text-base ml-7 sm:ml-0">{studentInfo.pesel}</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm sm:text-base ml-7 sm:ml-0">{studentInfo.class_name}</p>
                </div>
              </div>
            </div>  
          </div>
