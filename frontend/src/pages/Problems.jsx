      ...
      {userRole === UserRoles.Administrator && (
        <div>
          ...
          {activeTab === 'types' && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-textBg-800">Problem Types</h2>
                <Button 
                  icon={<Plus size={16}/>}
                ...
                <div className="flex flex-col gap-2">
                  {problemTypes.map((type) => (
                    <div key={type.id} className="border px-4 py-2 rounded flex justify-between items-center">
                      <p className='font-medium text-textBg-900'>{type.name}</p>
          ...
          {activeTab === 'statuses' && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-textBg-800">Statuses</h2>
                <Button 
                  icon={<Plus size={16}/>}
                ...
                <div className="flex flex-col gap-2">
                  {statuses.map((status) => (
                    <div key={status.id} className="border px-4 py-2 rounded flex justify-between items-center">
                      <p className='font-medium text-textBg-900'>{status.name}</p>
                      <div className="flex space-x-2">
                        <Button 
                          icon={<Trash size={16} color='#FF4D4F'/>} 
                          type="link" 
