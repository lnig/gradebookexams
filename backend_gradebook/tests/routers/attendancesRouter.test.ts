...
suite('attendancesRouter', () => {
    ...
    test('updateAttendance() - success', async () => {
        ...
        const updateAttendancesResponse = await sendPatchRequest(`/attendance/${attendance.id}`, attendanceUpdateData);
        ...
        assert.strictEqual(updateAttendancesResponse.body.data.was_present, false, `Expected the updated attendance presence to be "false".`);
        assert.strictEqual(updateAttendancesResponse.body.data.was_late, false, `Expected the updated attendance late flag to be "false".`);
        assert.strictEqual(updateAttendancesResponse.body.data.was_excused, false, `Expected the updated attendance excused flag to be "false".`);
    });
    ...
    test('updateAttendance() - validation error', async () => {
        ...
        const updateAttendancesResponse = await sendPatchRequest(`/attendance/${invalidIdUrl}`, attendanceUpdateData);
    ...
    test('updateAttendance() - absent and simultaneously late', async () => {
        ...
        const updateAttendancesResponse = await sendPatchRequest(`/attendance/${nonExistentId}`, attendanceUpdateData);
    ...
    test('updateAttendance() - present, not late and simultaneously excused', async () => {
        ...
        const updateAttendanceResponse = await sendPatchRequest(`/attendance/${nonExistentId}`, attendanceUpdateData);
