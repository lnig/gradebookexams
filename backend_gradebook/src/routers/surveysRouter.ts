...
import { createSurvey, sendSurvey, getSurvey, getSurveys, updateSurvey, deleteSurvey, getSurveyFullDetails } from '../handlers/surveys.js';
...
surveysRouter.get('/details/:surveyId',
    authenticate,
    authorize([UserType.Administrator, UserType.Teacher, UserType.Parent, UserType.Student]),
