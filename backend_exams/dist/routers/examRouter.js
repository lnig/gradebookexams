...
examRouter.get('/NewExamParticipants', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, exams_js_1.getExamParticipantsForNewExam);
examRouter.get('/checkAttemptEligibility/:exam_id', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Student]), middleware_1.handleInputErrors, attempts_js_1.checkAttemptEligibility);
examRouter.get('/getGradebookExams', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Teacher, userTypes_js_1.UserType.Administrator]), middleware_1.handleInputErrors, exams_js_1.getGradebookExams);
examRouter.get('/getExams', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Student, userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, exams_js_1.getExams);
examRouter.get('/:exam_id/getExamQuestions', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, exams_js_1.getAllExamQuestions);
examRouter.get('/:exam_id/getAllAttemptsToGrade', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, grading_js_1.getAllAttemptsToGrade);
examRouter.get('/getMyAttempts/:exam_id', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Student]), middleware_1.handleInputErrors, attempts_js_1.getUserAttempts);
...
examRouter.get('/:exam_id/getParticipants', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, exams_js_1.getExamParticipants);
...
examRouter.post('/:exam_id/upsertQuestionsToExam', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, questions_1.upsertQuestionsToExam);
...
examRouter.get('/checkExamState/:exam_id', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, grading_js_1.checkExamState);
...
examRouter.post('/gradeExam/:exam_id', auth_js_1.authenticate, (0, auth_js_1.authorize)([userTypes_js_1.UserType.Administrator, userTypes_js_1.UserType.Teacher]), middleware_1.handleInputErrors, grading_js_1.gradeExam);
